...
\section{Results}
    ...
    SUVmax and ADCmean of lymph nodes in endometrial and cervical cancer was analysed. No significant difference was found between regions in SUVmax or ADCmean on FDG-PET/CT and DW-MRI (Figure). Lymph nodes of the para-aortic region on FEC-PET/CT had significantly higher SUVmax than left and right pelvis. Interestingly, average SUVmax of all nodes on FDG-PET/CT was significantly higher in endometrial than in cervical cancer (Figure).
    
    % overview of quants in endo
    Quantitative measures, both raw and calculated, were compared in benign and malignant lymph nodes in endometrial cancer. All raw and calculated measures were significantly higher in malignant than benign lymph nodes on FDG-PET/CT (Figure A). Short-axis diameter, SUVmax, and STAR were all significantly elevated in malignant lymph nodes on FEC-PET/CT (Figure B). ADCmean and ADCmean NTR was not significantly different between benign and malignant lymph nodes in endometrial cancer (Figure C).

    % overview of quants in cer
    Low numbers of measured nodes in cervical cancer may limit the power of statistical analysis. No calculated or raw measures were significantly different between benign and malignant nodes on FDG-PET/CT and FEC-PET/CT, although mean measures were higher in malignant nodes (Figure ). Interestingly, ADCmean and ADCmean NTR were significantly lower in malignant nodes in cervical cancer (Figure B).

    % overview of quants in pt endo/cer
    Previous literature has shown elevated primary tumour SUVmax and depressed ADCmean in patients presenting with malignant lymph nodes \cite{}. SUVmax of the primary tumour was significantly elevated on FDG-PET/CT but not on FEC-PET/CT, with no significant difference found on DW-MRI (Figure ). No significant difference in any quantitative measure was found in primary tumours of the cervix.   

    % correlations between features!
    Pearson correlations coefficients were calculated between quantitative measures in endometrial cancer (Figure).
    ...
    % overview of diagnostic performance of quants
        % table!
    Diagnostic performance of each measure, along with optimal cutpoints, in endometrial cancer is summarised in Figure (). SUVmax from FDG-PET/CT showed relatively high sensitivity and specificity, with the highest AUC of the quantitative measures. AUC of SUVmax from FEC-PET/CT was lower than on FDG-PET/CT. Large error bars for FEC-PET/CT quantitative measures suggest low sample numbers may be restricting analysis and optimal cutpoints should be interpreted with caution. ADCmean showed high sensitivity, very low specificity, and very low AUC suggesting a high ADCmean cutpoint may reliably be able to diagnose patients with benign lymph nodes. 
