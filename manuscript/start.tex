...
\section{Results}
    ...
    \begin{figure}[h]
        ...
        \caption{
            ...
            Nodes of all regions are pooled together for this analysis. Significance was tested between groups using Mann-Whitney U-test. ***, p $<$ 0.001, **, p $<$ 0.01, *, p $<$ 0.05.  B, benign; M, malignant; SA, short-axis diameter, LA, long-axis diameter; NTR, nodal-to-tumour ratio (SUVmax for FDG-PET/CT and FEC-PET/CT, and ADCmean for DW-MRI); STAR, SUVmax-to-ADCmean ratio; SNSA, SUVmax normalised to SA diameter.
             }
    ...
    \begin{figure}[h]
        ...
        \caption{
            ...
            Nodes of all regions are pooled together for this analysis. Significance was tested between groups using Mann-Whitney U-test. *, p $<$ 0.05.  B, benign; M, malignant; SA, short-axis diameter, LA, long-axis diameter; NTR, nodal-to-tumour ratio (SUVmax for FDG-PET/CT and FEC-PET/CT, and ADCmean for DW-MRI); STAR, SUVmax-to-ADCmean ratio; SNSA, SUVmax normalised to SA diameter.
             }
