...
\section{Methods}
    ...
    SUVmax-to-ADCmean ratio (STAR) was also calculated by dividing the SUVmax by the ADCmean of the corresponding node. 
    SUVmax-to-SA diameter ratio (STSA) was calculated by dividing the SUVmax by the SA diameter for FDG-PET/CT and FEC-PET/CT.
    ...
    Due to the low number of nodes for cervical cancer and FEC-PET/CT, only FDG-PET/CT and DW-MRI data from endometrial cancer was considered when building models.
    ...
    Features in the training set was scaled between 0 and 1, and the same scaling function was applied to the test set. 
    ...
    Logistic LASSO regression shrunk all variables excluding SUVmax and SA diameter from FDG-PET/CT to zero. 
