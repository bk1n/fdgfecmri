...
ggsave('./figures/boxplot_raw_quants_byCancer.png',
       g,
       width = 5,
       height = 5,
       units = 'in',
...
ggsave('./figures/boxplot_raw_quants_byRegion.png',
       g,
       height = 5,
       width = 5,
       units = 'in',
...
ggsave('./figures/boxplot_quants_pt.png',
       g,
       width = 6,
       height = 8,
       units = 'in',
...
ggsave('./figures/boxplot_quants_endo.png',
       g,
       width = 10,
       height = 6,
       units = 'in',
...
ggsave('./figures/boxplot_quants_cer.png',
       g,
       width = 10,
       height = 6,
       units = 'in',
