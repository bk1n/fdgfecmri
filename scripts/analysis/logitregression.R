...
set.seed = 123
res.model = as.data.frame(do.call(rbind, pbmclapply(c(rep(NA, 5000)) ,runLogitRegr)))
...
write.csv(res.model, './figures/tables/lr.model_fullRes.csv')
...
write.csv(lr, './figures/tables/lr_roc_results.csv', row.names = F)
