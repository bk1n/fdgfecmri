...
write.csv(res.model.avg, './figures/tables/lr.model_optCutOff_SUV.csv')
write.csv(res.model, './figures/tables/lr.model_optCutOff_fullRes_SUV.csv')
...
write.csv(res.model.avg, './figures/tables/lr.model_performance_SUV.csv')
write.csv(res.model, './figures/tables/lr.model_fullRes_SUV.csv')

res.model.avg = read_csv('./figures/tables/lr.model_performance_SUV.csv')
opt_cutoff = read_csv('./figures/tables/lr.model_optCutOff_SUV.csv')
...
write.csv(lr, './figures/tables/lr_roc_results_SUV.csv', row.names = F)
...
ggsave('./figures/lr.model_plt_endo_SUV.png',
       g_lr,
       width = 5,
       height = 5,
       units = 'in',
