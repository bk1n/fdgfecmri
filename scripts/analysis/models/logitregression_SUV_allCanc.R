...
write.csv(res.model.avg, './figures/tables/lr.model_optCutOff_SUV_allCanc.csv')
write.csv(res.model, './figures/tables/lr.model_optCutOff_fullRes_SUV_allCanc.csv')
...
write.csv(res.model.avg, './figures/tables/lr.model_performance_SUV_allCanc.csv')
write.csv(res.model, './figures/tables/lr.model_fullRes_SUV_allCanc.csv')

res.model.avg = read_csv('./figures/tables/lr.model_performance_SUV_allCanc.csv')
opt_cutoff = read_csv('./figures/tables/lr.model_optCutOff_SUV_allCanc.csv')

lr.model.full = glm(HIST ~ FDG_SUV, 
                    fdg_lr,
                    family = binomial())
...
write.csv(lr, './figures/tables/lr_roc_results_SUV_allCanc.csv', row.names = F)
...
ggsave('./figures/lr.model_plt_endo_SUV_allCanc.png',
       g_lr,
       width = 5,
       height = 5,
       units = 'in',
