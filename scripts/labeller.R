...
#'
#' p3 <- ggplot(msleep, aes(x = sleep_total, y = awake)) +
#'   geom_point()
#' p3 +
...
labeller <- function(..., .rows = NULL, .cols = NULL,
  ...
  function(labels) {
    ...
    if (is.null(margin_labeller)) {
      ...
      margin_labeller <- as_labeller(margin_labeller,
        default = .default,
...
build_strip <- function(label_df, labeller, theme, horizontal) {
  ...
  if (horizontal) {
    grobs_top <- lapply(labels_vec, element_render,
      theme = theme,
    ...
    grobs_bottom <- lapply(labels_vec, element_render,
      theme = theme,
    ...
    grobs_left <- lapply(labels_vec, element_render,
      theme = theme,
